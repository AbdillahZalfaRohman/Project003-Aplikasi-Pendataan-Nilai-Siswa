...
namespace Belajar_Crud
{
    public partial class Mapel : Form
    {
        ...
        private void txtkodemapel_TextChanged(object sender, EventArgs e)
        {

        }

        private void cbnamaguru_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void txtnamamapel_TextChanged(object sender, EventArgs e)
        {
